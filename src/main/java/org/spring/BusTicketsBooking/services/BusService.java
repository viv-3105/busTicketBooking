...
public class BusService {
    ...
    public PassengerModel[][] getSeats() {
		return seats;
	}

	public void setSeats(PassengerModel[][] seats) {
		this.seats = seats;
	}

	public List<PassengerModel> getListOfPassengers() {
		return listOfPassengers;
	}

	public void setListOfPassengers(List<PassengerModel> listOfPassengers) {
